...
public abstract class OverScrollBounceEffectDecoratorBase implements IOverScrollDecor, View.OnTouchListener {
    ...
    public VerticalOverScrollBounceEffectDecorator.ValueTouch valueTouch;
    ...
    public OverScrollBounceEffectDecoratorBase(IOverScrollDecoratorAdapter viewAdapter, float decelerateFactor, float touchDragRatioFwd, float touchDragRatioBck, VerticalOverScrollBounceEffectDecorator.ValueTouch valueTouch) {
        mViewAdapter = viewAdapter;
        this.valueTouch = valueTouch;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (valueTouch != null && valueTouch.isEnable()) {
                    return true;
                } else {
                    return mCurrentState.handleMoveTouchEvent(event, xDown, yDown, timeDown);
                }
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mStateListener != null) {
                    mStateListener.onScrollStateCancel();
                }
        }
    ...
    protected interface IDecoratorState {
         ...
         */
        boolean handleMoveTouchEvent(MotionEvent event, float xDown, float yDown, long timeDown);
    ...
    protected abstract static class MotionAttributes {
        ...
        protected abstract boolean init(View view, MotionEvent event, float xHistoryFirst, float yHistoryFirst);
    }
    ...
    protected class IdleState implements IDecoratorState {
        ...
        @Override
        public boolean handleMoveTouchEvent(MotionEvent event, float xDown, float yDown, long timeDown) {

            final View view = mViewAdapter.getView();
            if (!mMoveAttr.init(view, event, xDown, yDown)) {
                return false;
            }
            ...
            if ((mViewAdapter.isInAbsoluteStart() && mMoveAttr.mDir) ||
                ...
                return mOverScrollingState.handleMoveTouchEvent(event, xDown, yDown, timeDown);
            }
    ...
    protected class OverScrollingState implements IDecoratorState {
        ...
        @Override
        public boolean handleMoveTouchEvent(MotionEvent event, float xDown, float yDown, long timeOnDown) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                ...
                case MotionEvent.ACTION_MOVE:
                    yCurrent = event.getRawY();
                    if (yCurrent >= yDown) {
                        // Người dùng đang kéo xuống, bỏ qua sự kiện
                        return true;
                    }
                    break;
                case MotionEvent.ACTION_UP:
...
//            if (downY -oldDownY>)
            ...
            if (mStartAttr.mPointerId != event.getPointerId(0)) {
                ...
                //Log.e(TAG, "handleMoveTouchEvent block scroll mPointerId: ");
                return true;
            }
            ...
            if (!mMoveAttr.init(view, event, xDown, yDown)) {
                ...
                //Log.e(TAG, "handleMoveTouchEvent block scroll init, yDown:" + yDown + " downY: " + downY);
                return true;
            }
...
//            if(valueTouch != null && newOffset>0){
//                newOffset =0f;
//            }
            ...
            if (event.getHistorySize() > 0) {
                timeTouchFirst = event.getHistoricalEventTime(0);
            } else {
                timeTouchFirst = timeOnDown;
            }
            long dt = event.getEventTime() - timeTouchFirst;
            ...
            //Log.e("hoangld", "handleMoveTouchEvent newOffset: "+newOffset + " yDonw: " + yDown + " downyCurrent: " + downY);
