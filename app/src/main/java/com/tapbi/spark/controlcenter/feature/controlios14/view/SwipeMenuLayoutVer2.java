...
public class SwipeMenuLayoutVer2 extends ConstraintLayout {
    ...
    public SwipeMenuLayoutVer2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SwipeMenuLayoutVer2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//                    if (Math.abs(spaceCurrent) < 10) {
    ...
    private void init(AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.SwipeLayoutNoty);
