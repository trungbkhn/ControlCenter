...
import com.tapbi.spark.controlcenter.databinding.LayoutControlSettingSquareBinding;
...
public class SettingViewSquare extends ConstraintLayoutBase {
    ...
    private LayoutControlSettingSquareBinding binding;

    public SettingViewSquare(@NonNull Context context) {
        super(context);
        init(context);
    }

    public SettingViewSquare(@NonNull Context context, ControlSettingIosModel controlSettingIosModel) {
        super(context);
        this.controlSettingIOS = controlSettingIosModel;
        init(context);
    }

    public SettingViewSquare(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public SettingViewSquare(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    void init(Context context) {
        binding = LayoutControlSettingSquareBinding.inflate(LayoutInflater.from(context), this, true);
