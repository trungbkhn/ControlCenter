        ...
        if (isSwipeEnable) {
            ...
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (onSwipeListener != null && getScrollX() <= mRightMenuWidths && getScrollX() >= 0) {
//                        translation += gap;
                        onSwipeListener.onSwipe(getScrollX());
                    }
    ...
    public void smoothExpand() {
        ...
        mExpandAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                translation = (Integer) animation.getAnimatedValue();
        ...
        try {
            ...
            float valueResult = velocityX / 1000;
            mExpandAnim.setInterpolator(new OvershootInterpolator(valueResult));
        } catch (Exception e) {
    ...
    public void smoothClose(boolean isSpring) {
        mViewCache = null;
        if (null != mContentView) {
        ...
        if (isSpring) {
            try {
                ...
                velocityX = Math.abs(velocityX);
                float valueResult = velocityX / 1000;
                mCloseAnim.setInterpolator(new OvershootInterpolator(valueResult));
            } catch (Exception e) {
    ...
    public void scrollUpdateBlur() {
//        int x = getScrollX();
//        ValueAnimator valueAnimator = ValueAnimator.ofInt(x + 5, x);
//        valueAnimator.setDuration(100);
//        valueAnimator.setInterpolator(new DecelerateInterpolator());
//        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
//            @Override
//            public void onAnimationUpdate(ValueAnimator animation) {
//                Timber.e("translation3: "+animation.getAnimatedValue());
//                scrollTo((Integer) animation.getAnimatedValue(), 0);
//            }
//        });
//        valueAnimator.start();
