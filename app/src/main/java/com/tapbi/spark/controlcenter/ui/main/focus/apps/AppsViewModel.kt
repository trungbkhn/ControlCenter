...
class AppsViewModel @Inject constructor() : BaseViewModel() {
    ...
    fun deleteAllItemAutomation(nameFocus: String?) {
        App.ins.applicationRepository.deleteItemAppAutomation(nameFocus)
            .subscribe(object : SingleObserver<Boolean> {
                ...
                override fun onSuccess(aBoolean: Boolean) {
                    deleteAutomationFocus.postValue(aBoolean)
                }
    ...
    fun insertAppAutomation(turnOn: ItemTurnOn?) {
        Completable.fromRunnable { App.ins.applicationRepository.insertAppAutomation(turnOn) }
            .subscribeOn(
                Schedulers.io()
