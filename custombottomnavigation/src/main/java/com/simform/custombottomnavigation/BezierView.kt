...
class BezierView : View {
    ...
    private val shadowHeight =
        dipf(context, 27)   // this height will change bottomnavigation bg height
    private val reverseCurveHeight =
        dipf(context, 10)   // this will change bottomnavigation bg height reverse
    private val radiusTop = DimensionHelper.dpToPx(6)
    private val radiusBottom = DimensionHelper.dpToPx(26)
    var color = 0
        set(value) {
            field = value
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        bezierInnerWidth = dipf(context, 72)
    ...
    private fun drawInner(canvas: Canvas, isShadow: Boolean) {
        ...
        calculateInner()
        path!!.lineTo(innerArray[0].x, innerArray[0].y + radiusTop)
        path.cubicTo(
            innerArray[0].x,
            innerArray[0].y + radiusTop,
            innerArray[0].x,
            innerArray[0].y,
            innerArray[0].x + radiusTop,
            innerArray[0].y
        )
        path.lineTo(innerArray[0].x + radiusTop, innerArray[0].y)
        ...
        path.lineTo(innerArray[8].x - radiusTop, innerArray[8].y)
        path.cubicTo(
            innerArray[8].x - radiusTop,
            innerArray[8].y,
            innerArray[8].x,
            innerArray[8].y,
            innerArray[8].x,
            innerArray[8].y + radiusTop
        )
        path.lineTo(innerArray[9].x, innerArray[9].y - radiusBottom)
        path.cubicTo(
            innerArray[9].x,
            innerArray[9].y - radiusBottom,
            innerArray[9].x,
            innerArray[9].y,
            innerArray[9].x - radiusBottom,
            innerArray[9].y
        )
        path.lineTo(innerArray[10].x + radiusBottom, innerArray[10].y)
        path.cubicTo(
            innerArray[10].x + radiusBottom,
            innerArray[10].y,
            innerArray[10].x,
            innerArray[10].y,
            innerArray[10].x,
            innerArray[10].y - radiusBottom
        )
    ...
    private fun calculateInner() {
        ...
        if (bezierX == 0F) {
            pickHeight = bezierInnerHeight + extra
        }
    ...
    private fun drawProgress(canvas: Canvas, isShadow: Boolean) {
        //Log.e("hoangLd drawProgress", "bezierX: " + bezierX)
        val paint = if (isShadow) shadowPaint else mainPaint
        val path = if (isShadow) shadowPath else mainPath
...
//        path.lineTo(progressArray[10].x, progressArray[10].y)
        ...
        path!!.lineTo(progressArray[0].x, progressArray[0].y + radiusTop)
        path.cubicTo(
            progressArray[0].x,
            progressArray[0].y + radiusTop,
            progressArray[0].x,
            progressArray[0].y,
            progressArray[0].x + radiusTop,
            progressArray[0].y
        )
        path.lineTo(progressArray[0].x + radiusTop, progressArray[0].y)
        path.lineTo(progressArray[1].x, progressArray[1].y)
        path.cubicTo(
            progressArray[2].x,
            progressArray[2].y,
        ...
        path.lineTo(progressArray[8].x - radiusTop, progressArray[8].y)
        path.cubicTo(
            progressArray[8].x - radiusTop,
            progressArray[8].y,
            progressArray[8].x,
            progressArray[8].y,
            progressArray[8].x,
            progressArray[8].y + radiusTop
        )
        path.lineTo(progressArray[9].x, progressArray[9].y - radiusBottom)
        path.cubicTo(
            progressArray[9].x,
            progressArray[9].y - radiusBottom,
            progressArray[9].x,
            progressArray[9].y,
            progressArray[9].x - radiusBottom,
            progressArray[9].y
        )
        path.lineTo(progressArray[10].x + radiusBottom, progressArray[10].y)
        path.cubicTo(
            progressArray[10].x + radiusBottom,
            progressArray[10].y,
            progressArray[10].x,
            progressArray[10].y,
            progressArray[10].x,
            progressArray[10].y - radiusBottom
        )
