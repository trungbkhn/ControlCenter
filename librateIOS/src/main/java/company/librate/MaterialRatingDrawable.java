...
public class MaterialRatingDrawable extends LayerDrawable {
    ...
    public MaterialRatingDrawable(Context context, boolean fillBackgroundStars) {
        super(new Drawable[]{
                createLayerDrawableWithTintAttrRes(fillBackgroundStars ?
                        ...
                        androidx.appcompat.R.attr.colorControlHighlight : androidx.appcompat.R.attr.colorControlNormal, context),
                fillBackgroundStars ? createClippedLayerDrawableWithTintColor(
                        ...
                        R.drawable.mrb_star_border_icon_black_36dp, androidx.appcompat.R.attr.colorControlActivated,
                        context),
    ...
    private static Drawable createLayerDrawableWithTintColor(int tileRes, int tintColor,
        ...
        try {
            drawable = new TileDrawable(AppCompatResources.getDrawable(context,
                    tileRes));
        } catch (Exception e) {
            drawable = new TileDrawable(new ColorDrawable(Color.TRANSPARENT));
        }
